...
import QuicklinkAndFeedBack from "./QuicklinksAndFeedBack/QuicklinksAndFeedBack";
import { IQuickFeedBackProps } from "./IQuickFeedBackProps";
import { useState } from "react"
import { getSP } from "../../../Services/pnpConfig";
import "../../../Styles/GlobalStyles/global.scss"
import { WebPartContext } from "@microsoft/sp-webpart-base";
import FeedBack from "./QuicklinksAndFeedBack/FeedBack";

const QuicklinksAndFeedBack = (props: IQuickFeedBackProps) => {
    let arrobj: any[] = [];
     ...
     <>
      <div className="row2container__part2">
            <div className="row2container__part2_quicklinks">
              <QuicklinkAndFeedBack data={quicklinkdata} />
            </div>
...
export default QuicklinksAndFeedBack